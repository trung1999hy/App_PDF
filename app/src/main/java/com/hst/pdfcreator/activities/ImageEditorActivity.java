...
import com.hst.pdfcreator.adapter.ImagesAdapter;
import com.hst.pdfcreator.adapter.BrushItemAdapter;
...
import com.hst.pdfcreator.interfaces.OnFilterItemClickedListener;
import com.hst.pdfcreator.interfaces.OnItemClickListener;
import com.hst.pdfcreator.pdfModel.BrushItem;
import com.hst.pdfcreator.pdfModel.FilterItem;
import com.hst.pdfcreator.util.BrushUtils;
import com.hst.pdfcreator.util.ImageFilterUtils;
import com.hst.pdfcreator.util.StringUtils;
import com.hst.pdfcreator.util.ThemeUtils;

import static com.hst.pdfcreator.Constants.IMAGE_EDITOR_KEY;
import static com.hst.pdfcreator.Constants.RESULT;

public class ImageEditorActivity extends AppCompatActivity implements OnFilterItemClickedListener, OnItemClickListener {
    ...
    private void initRecyclerView() {
        ...
        ImagesAdapter adapter = new ImagesAdapter(mFilterItems, this, this);
        recyclerView.setAdapter(adapter);

        LinearLayoutManager layoutManager2 = new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false);
        brushColorsView.setLayoutManager(layoutManager2);
        BrushItemAdapter adapterBrushItem = new BrushItemAdapter(this,
                this, mBrushItems);
