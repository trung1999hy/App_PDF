...
import com.hst.pdfcreator.adapter.AdapterRearrangePdf;
...
import static com.hst.pdfcreator.Constants.SAME_FILE;

public class RearrangePdfPagesActivity extends AppCompatActivity implements AdapterRearrangePdf.OnClickListener {
    ...
    public static Intent getStartIntent(Context context) {
        return new Intent(context, RearrangePdfPagesActivity.class);
    }
}
