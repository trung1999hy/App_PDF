...
import com.hst.pdfcreator.adapter.AdapterRearrangeImages;
import com.hst.pdfcreator.Constants;
import com.hst.pdfcreator.util.DialogUtils;
import com.hst.pdfcreator.util.ImageSortUtils;
import com.hst.pdfcreator.util.ThemeUtils;

import static com.hst.pdfcreator.Constants.CHOICE_REMOVE_IMAGE;
import static com.hst.pdfcreator.Constants.PREVIEW_IMAGES;

public class RearrangeImagesActivity extends AppCompatActivity implements AdapterRearrangeImages.OnClickListener {
    ...
    public static Intent getStartIntent(Context context, ArrayList<String>  uris) {
        Intent intent = new Intent(context, RearrangeImagesActivity.class);
