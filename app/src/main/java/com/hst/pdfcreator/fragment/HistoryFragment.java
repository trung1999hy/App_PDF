...
import com.hst.pdfcreator.adapter.HistoriesAdapter;
import com.hst.pdfcreator.db.AppDatabase;
import com.hst.pdfcreator.db.History;
...
public class HistoryFragment extends Fragment implements HistoriesAdapter.OnClickListener {
    ...
    private HistoriesAdapter mAdapterHistory;
    ...
    private class LoadHistory extends AsyncTask<String[], Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            if (mHistoryList != null && !mHistoryList.isEmpty()) {
                ...
                mAdapterHistory = new HistoriesAdapter(mActivity, mHistoryList, HistoryFragment.this);
