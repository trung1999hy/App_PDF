package com.hst.pdfcreator.fragment;
...
import com.hst.pdfcreator.activities.ImageEditorActivity;
import com.hst.pdfcreator.activities.PreviewActivity;
import com.hst.pdfcreator.activities.HomeActivity;
import com.hst.pdfcreator.activities.RearrangeImagesActivity;
...
import hst.R;
import com.hst.pdfcreator.activities.CropImageActivity;
import com.hst.pdfcreator.adapter.EnhancementOptionsAdapter;
import com.hst.pdfcreator.db.DatabaseHelper;
import com.hst.pdfcreator.interfaces.OnItemClickListener;
import com.hst.pdfcreator.interfaces.OnPDFCreatedInterface;
import com.hst.pdfcreator.pdfModel.EnhancementOptionsEntity;
import com.hst.pdfcreator.pdfModel.ImageToPDFOptions;
import com.hst.pdfcreator.pdfModel.Watermark;
import com.hst.pdfcreator.Constants;
import com.hst.pdfcreator.util.CreatePdf;
import com.hst.pdfcreator.util.DefaultTextWatcher;
import com.hst.pdfcreator.util.DialogUtils;
import com.hst.pdfcreator.util.FileUtils;
import com.hst.pdfcreator.util.ImageEnhancementOptionsUtils;
import com.hst.pdfcreator.util.ImageUtils;
import com.hst.pdfcreator.util.MorphButtonUtility;
import com.hst.pdfcreator.util.PageSizeUtils;
import com.hst.pdfcreator.util.PermissionsUtils;
import com.hst.pdfcreator.util.SharedPreferencesUtil;
import com.hst.pdfcreator.util.StringUtils;

import static com.hst.pdfcreator.Constants.DEFAULT_BORDER_WIDTH;
import static com.hst.pdfcreator.Constants.DEFAULT_COMPRESSION;
import static com.hst.pdfcreator.Constants.DEFAULT_IMAGE_BORDER_TEXT;
import static com.hst.pdfcreator.Constants.DEFAULT_IMAGE_SCALE_TYPE_TEXT;
import static com.hst.pdfcreator.Constants.DEFAULT_PAGE_COLOR;
import static com.hst.pdfcreator.Constants.DEFAULT_PAGE_SIZE;
import static com.hst.pdfcreator.Constants.DEFAULT_PAGE_SIZE_TEXT;
import static com.hst.pdfcreator.Constants.DEFAULT_QUALITY_VALUE;
...
import static com.hst.pdfcreator.Constants.RESULT;
import static com.hst.pdfcreator.Constants.STORAGE_LOCATION;
import static com.hst.pdfcreator.Constants.WRITE_PERMISSIONS;
import static com.hst.pdfcreator.Constants.appName;
import static com.hst.pdfcreator.util.WatermarkUtils.getStyleNameFromFont;
import static com.hst.pdfcreator.util.WatermarkUtils.getStyleValueFromName;
...
//            StringUtils.getInstance().showSnackbar(mActivity, R.string.snackbar_no_images);
        ...
        switch (position) {
            ...
            case 2:
                ...
                break;
            case 3:
                startActivityForResult(ImageEditorActivity.getStartIntent(mActivity, mImagesUri),
            ...
            case 7:
                ...
                break;
            case 8:
                startActivityForResult(RearrangeImagesActivity.getStartIntent(mActivity, mImagesUri),
