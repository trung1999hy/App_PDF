...
import com.hst.pdfcreator.adapter.AdapterWhatsNew;
import com.hst.pdfcreator.pdfModel.WhatsNew;
...
public class WhatsNewUtils {
    ...
    public void displayDialog(Context context) {
        ...
        try {
            ...
            AdapterWhatsNew adapterWhatsNew = new AdapterWhatsNew(context, extractItemsFromJSON(obj));
            LinearLayoutManager layoutManager = new LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false);
            rv.setLayoutManager(layoutManager);
            rv.setAdapter(adapterWhatsNew);
            dialog.show();
