...
public class HistoriesAdapter extends RecyclerView.Adapter<HistoriesAdapter.ViewHistoryHolder> {
    ...
    public HistoriesAdapter(Activity mActivity, List<History> mHistoryList, OnClickListener mOnClickListener) {
    ...
    public ViewHistoryHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new HistoriesAdapter.ViewHistoryHolder(itemView);
    }
