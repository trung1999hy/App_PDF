...
public class FilesAdapter extends RecyclerView.Adapter<FilesAdapter.ViewMergeFilesHolder> {

    private final ArrayList<String> mFilePaths;
    private final Activity mContext;
    private final OnFileItemClickedListener mOnClickListener;

    public FilesAdapter(Activity mContext, ArrayList<String> mFilePaths,
    ...
    public ViewMergeFilesHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FilesAdapter.ViewMergeFilesHolder(itemView);
    }
