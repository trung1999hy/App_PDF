package com.hst.pdfcreator.adapter;
...
import com.hst.pdfcreator.interfaces.DataSetChanged;
import com.hst.pdfcreator.interfaces.EmptyStateChangeListener;
import com.hst.pdfcreator.interfaces.ItemSelectedListener;
import com.hst.pdfcreator.pdfModel.PDFFile;
import com.hst.pdfcreator.util.DialogUtils;
import com.hst.pdfcreator.util.DirectoryUtils;
import com.hst.pdfcreator.util.FileInfoUtils;
import com.hst.pdfcreator.util.FileSortUtils;
import com.hst.pdfcreator.util.FileUtils;
import com.hst.pdfcreator.util.PDFEncryptionUtility;
import com.hst.pdfcreator.util.PDFRotationUtils;
import com.hst.pdfcreator.util.PDFUtils;
import com.hst.pdfcreator.util.PopulateList;
import com.hst.pdfcreator.util.StringUtils;
import com.hst.pdfcreator.util.WatermarkUtils;

import static com.hst.pdfcreator.Constants.SORTING_INDEX;
import static com.hst.pdfcreator.util.FileInfoUtils.getFormattedDate;
...
public class AdapterViewFiles extends RecyclerView.Adapter<AdapterViewFiles.ViewFilesHolder>
     ...
     *
     * @param activity                 the activities calling this adapter
